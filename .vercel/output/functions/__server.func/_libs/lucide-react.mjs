...
const ArrowRightLeft = createLucideIcon("arrow-right-left", __iconNode$10);
const __iconNode$$ = [
...
const ClipboardCopy = createLucideIcon("clipboard-copy", __iconNode$J);
const __iconNode$I = [
  ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }],
...
const Receipt = createLucideIcon("receipt", __iconNode$m);
const __iconNode$l = [
...
const ReceiptText = createLucideIcon("receipt-text", __iconNode$l);
const __iconNode$k = [
...
const Scale = createLucideIcon("scale", __iconNode$i);
const __iconNode$h = [
...
const SearchX = createLucideIcon("search-x", __iconNode$h);
const __iconNode$g = [
...
const Settings2 = createLucideIcon("settings-2", __iconNode$f);
const __iconNode$e = [
  [
    "path",
    {
...
const Split = createLucideIcon("split", __iconNode$b);
const __iconNode$a = [
