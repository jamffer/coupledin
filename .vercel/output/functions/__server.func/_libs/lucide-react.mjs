...
const ArrowDown = createLucideIcon("arrow-down", __iconNode$_);
const __iconNode$Z = [
...
const ArrowRightLeft = createLucideIcon("arrow-right-left", __iconNode$Z);
const __iconNode$Y = [
...
const ClipboardCopy = createLucideIcon("clipboard-copy", __iconNode$H);
const __iconNode$G = [
  ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }],
...
const PiggyBank = createLucideIcon("piggy-bank", __iconNode$m);
const __iconNode$l = [
  ["path", { d: "M5 12h14", key: "1ays0h" }],
  ["path", { d: "M12 5v14", key: "s699le" }]
];
...
const ReceiptText = createLucideIcon("receipt-text", __iconNode$j);
const __iconNode$i = [
