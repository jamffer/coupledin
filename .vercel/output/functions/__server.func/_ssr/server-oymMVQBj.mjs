...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-a3uzxfYw.mjs");
...
const manifest = {
  "ff0ad7c6eed40bcfc0fa108fa7a794fdd29fbdeedb9161f153630792ad349914": {
    ...
    importer: () => import("./transactions.functions-nhKTjGyS.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-qkx3yTPs.mjs").then((n) => n.r),
    import("./start-CkR3WcvH.mjs"),
