...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CUQm-w-z.mjs");
...
const manifest = {
  "ff0ad7c6eed40bcfc0fa108fa7a794fdd29fbdeedb9161f153630792ad349914": {
    functionName: "parseTransactionFromText_createServerFn_handler",
    importer: () => import("./transactions.functions-Cpr1b3lH.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-Dl0zekrI.mjs").then((n) => n.r),
    import("./start-CCu4xoN_.mjs"),
