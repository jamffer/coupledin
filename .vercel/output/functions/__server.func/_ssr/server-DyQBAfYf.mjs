...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-B1aMwqQJ.mjs");
...
const manifest = {
  "ff0ad7c6eed40bcfc0fa108fa7a794fdd29fbdeedb9161f153630792ad349914": {
    ...
    importer: () => import("./transactions.functions-BmjPSccJ.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router--zSI1aDr.mjs").then((n) => n.r),
    import("./start-rVvFUtfe.mjs"),
