...
import { a as Logo, L as Label, I as Input } from "./label-BppqprV3.mjs";
...
import { Q as Mail, V as Lock, L as LoaderCircle, X as User, t as CircleAlert, Y as RefreshCcw, U as Users, k as UserPlus, h as Check, i as Copy, j as ArrowRight } from "../_libs/lucide-react.mjs";
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { initial: {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center space-y-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { initial: {
          ...
          duration: 0.6,
          ease: "easeOut"
        }, className: "flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Logo, { className: "h-12 w-auto mb-8 min-w-[140px]" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground italic text-sm", children: "Seu patrimônio, sonhos e planos em harmonia." })
      ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center space-y-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground", children: step === OnboardingStep.ERROR ? "Algo não saiu como o esperado." : "Como você quer começar no CoupleDin?" })
      ] }),
