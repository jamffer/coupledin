...
const appCss = "/assets/styles-CUESsU0N.css";
...
const $$splitComponentImporter$8 = () => import("./transacoes-C4cLX-MS.mjs");
const Route$8 = createFileRoute("/transacoes")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Gerencie as transaÃ§Ãµes do casal."
    }]
  }),
...
const $$splitComponentImporter$7 = () => import("./relatorios-Dm82ObfB.mjs");
const Route$7 = createFileRoute("/relatorios")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "AnÃ¡lise de gastos e fechamento do mÃªs do casal."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$7, "component")
});
const $$splitComponentImporter$6 = () => import("./metas-CzikmWbE.mjs");
...
const $$splitComponentImporter$5 = () => import("./invite-Diy-KJlx.mjs");
const Route$5 = createFileRoute("/invite")({
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import("./investimentos-DQ3_sKCj.mjs");
...
const $$splitComponentImporter$3 = () => import("./configuracoes-dz7E1mlS.mjs");
...
const $$splitComponentImporter$2 = () => import("./cartoes-BdbH4Xbt.mjs");
const Route$2 = createFileRoute("/cartoes")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Gerencie seus cartÃµes de crÃ©dito e faturas."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./auth-BihPtI-C.mjs");
const Route$1 = createFileRoute("/auth")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "FaÃ§a login para gerenciar suas finanÃ§as a dois."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./index-pZKBRbIs.mjs");
const Route = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "FinanÃ§as do casal em um sÃ³ lugar."
    }]
  }),
  validateSearch: (search) => {
    return {
