...
import { d as useNavigate, f as useRouterState, L as Link } from "../_libs/tanstack__react-router.mjs";
...
import { a as CircleQuestionMark, d as TrendingUp, H as Heart, _ as House, $ as Car, X as Coffee, a0 as ShoppingBag, K as User, a1 as Split, U as Users, a2 as Sun, a3 as Moon, P as Plus, C as CirclePlus, a4 as LogOut, L as LoaderCircle, g as Check, h as Copy, Y as ChevronDown, a5 as X, a6 as Camera, k as LayoutDashboard, a7 as ReceiptText, z as CreditCard, f as Target, a8 as Settings, a9 as PanelLeft, aa as ChevronUp } from "../_libs/lucide-react.mjs";
function useProfile() {
  const { user } = useAuth();
...
function AppSidebar() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Sidebar, { collapsible: "icon", className: "border-r border-sidebar-border bg-sidebar z-[100] shadow-xl transition-all duration-300 pointer-events-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarHeader, { className: "h-16 flex items-center px-6 border-b border-white/10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 font-bold text-xl tracking-tight text-primary", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: "/CoupleDin.png", alt: "CoupleDin", className: "w-full h-full object-contain" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "group-data-[collapsible=icon]:hidden", children: "CoupleDin" })
    ] }) }),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(TooltipProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(SidebarProvider, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex flex-col min-w-0 relative z-10 transition-all duration-300", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "h-16 flex items-center justify-between px-4 md:px-8 border-b border-border/40 bg-background/80 backdrop-blur-xl sticky top-0 z-40 transition-colors", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-lg font-bold text-foreground", children: getGreeting() }) })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 md:gap-6", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Dialog, { open: isNewRecordOpen, onOpenChange: setIsNewRecordOpen, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(Tooltip, { children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(TooltipContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Adicionar nova transaÃ§Ã£o" }) })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { className: "apple-card dark:bg-[#1A1A1A] border-border/40", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogHeader, { children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(DialogDescription, { children: "Adicione uma nova transaÃ§Ã£o rapidamente ou vÃ¡ para a pÃ¡gina detalhada." })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-6 py-4", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-4 items-center gap-4", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "desc", className: "text-right font-medium", children: "DescriÃ§Ã£o" }),
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-4 items-center gap-4", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { defaultValue: "saida", children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { className: "apple-card", children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "saida", children: "SaÃ­da" })
                      ] })
                    ] })
                  ] })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { className: "gap-2 sm:gap-0", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "ghost", className: "rounded-xl active:scale-95 transition-all", onClick: () => navigate({ to: "/transacoes" }), children: "Ir para LanÃ§amentos" }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Dialog, { open: isProfileOpen, onOpenChange: setIsProfileOpen, children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { className: "apple-card dark:bg-[#1A1A1A] border-border/40 sm:max-w-md overflow-hidden", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogHeader, { children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(DialogDescription, { className: "text-center", children: "Personalize como vocÃª aparece no CoupleDin." })
                ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: isNameModalOpen, onOpenChange: (open) => {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogHeader, { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(DialogDescription, { className: "text-center", children: "Como vocÃª gostaria de ser chamado(a)? Precisamos disso para personalizar sua experiÃªncia." })
      ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: showInviteDialogInLayout, onOpenChange: setShowInviteDialogInLayout, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { className: "apple-card dark:bg-[#1A1A1A] border-border/40 sm:max-w-md pointer-events-auto z-[1000]", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogHeader, { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(DialogDescription, { className: "text-center", children: "Compartilhe o cÃ³digo abaixo para que seu parceiro(a) possa se conectar a este espaÃ§o." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-6 py-8 px-4", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground text-center italic", children: 'O seu parceiro(a) deve escolher "Ingressar em um espaÃ§o" e inserir este cÃ³digo no Onboarding.' })
      ] })
    ] }) })
  ] }) });
}
