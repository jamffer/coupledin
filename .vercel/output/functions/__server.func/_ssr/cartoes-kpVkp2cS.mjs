...
import { D as DashboardLayout, T as TooltipProvider, u as useProfile, i as Dialog, s as DialogTrigger, j as DialogContent, k as DialogHeader, l as DialogTitle, m as DialogDescription, S as Select, b as SelectTrigger, c as SelectValue, d as SelectContent, e as SelectItem } from "./layout-dashboard-DYPsAunJ.mjs";
...
import { f as format, a as startOfMonth, s as subMonths, b as parseISO, p as ptBR } from "../_libs/date-fns.mjs";
import { N as CreditCard, d as CircleCheck, v as Calendar, G as ChevronRight, E as EllipsisVertical, O as ShoppingBag, L as LoaderCircle, P as Plus } from "../_libs/lucide-react.mjs";
...
function EditCardModal({ card, open, onOpenChange }) {
  const [isUpdating, setIsUpdating] = reactExports.useState(false);
  const queryClient = useQueryClient();
  const form = useForm({
    resolver: u(editCardSchema),
    defaultValues: {
      name: "",
      totalLimit: "",
      closingDay: ""
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open, onOpenChange, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { className: "sm:max-w-[425px] apple-card", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogHeader, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { children: "Editar Cartão" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogDescription, { children: "Altere as informações do cartão selecionado." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Form, { ...form, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: form.handleSubmit(onSubmit), className: "space-y-4 pt-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        FormField,
        {
          ...
          render: ({ field }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(FormItem, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(FormLabel, { children: "Nome do Cartão" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(FormControl, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { placeholder: "Ex: Nubank, Itaú...", ...field, disabled: isUpdating }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(FormMessage, {})
          ] })
        }
      ),
...
function CartoesPage() {
  ...
  const [cardToEdit, setCardToEdit] = reactExports.useState(null);
  const {
    user,
    loading: authLoading
  } = useAuth();
  ...
  const currentBillItems = selectedCardId ? transactions.filter((tx) => {
  ...
  selectedCard ? selectedCard.limitUsed / (selectedCard.totalLimit || 1) * 100 : 0;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(DashboardLayout, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(TooltipProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { variants: containerVariants, initial: "hidden", animate: "visible", className: "space-y-8", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { className: "border-b border-border/40 px-6 py-4 flex flex-col md:flex-row md:items-center justify-between gap-4", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenu, { children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(DropdownMenuContent, { className: "apple-card w-[180px]", children: availableMonths.map((m) => /* @__PURE__ */ jsxRuntimeExports.jsx(DropdownMenuItem, { onClick: () => setSelectedMonth(m), className: "capitalize", children: format(parseISO(m), "MMMM (yyyy)", {
                  locale: ptBR
                }) }, m)) })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: selectedMonth === format(/* @__PURE__ */ new Date(), "yyyy-MM-01") ? "outline" : "secondary", children: selectedMonth === format(/* @__PURE__ */ new Date(), "yyyy-MM-01") ? "Fatura Aberta" : "Fatura Paga" })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-4 divide-y md:divide-y-0 md:divide-x border-b border-border/40", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6 flex flex-col justify-between", children: [
                ...
                selectedMonth === currentMonth && /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialog, { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Table, { children: [
              ...
              ] }, item.id)) : /* @__PURE__ */ jsxRuntimeExports.jsx(TableRow, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { colSpan: 7, className: "py-12", children: /* @__PURE__ */ jsxRuntimeExports.jsx(EmptyState, { icon: ShoppingBag, title: "Nenhum lançamento nesta fatura", description: "Você ainda não usou este cartão no mês selecionado.", actionLabel: "Ir para Transações", onAction: () => navigate({
                to: "/transacoes"
              }) }) }) }) })
            ] }) })
          ] })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(EditCardModal, { card: cardToEdit, open: isEditModalOpen, onOpenChange: setIsEditModalOpen })
  ] });
}
export {
