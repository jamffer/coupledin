...
import { G as Mail, J as Lock, L as LoaderCircle, K as User, N as CircleAlert, O as RefreshCcw, U as Users, j as UserPlus, g as Check, h as Copy, i as ArrowRight } from "../_libs/lucide-react.mjs";
...
const inviteCodeSchema = string().min(6, "O cÃ³digo deve ter pelo menos 6 caracteres").max(12, "O cÃ³digo Ã© muito longo").regex(/^[A-Z0-9]+$/, "O cÃ³digo deve conter apenas letras e nÃºmeros");
function AuthPage() {
  ...
  const handleSignUp = async (e) => {
    ...
    try {
      ...
      toast.success("Conta criada!", {
        description: "Continuando para a criaÃ§Ã£o do espaÃ§o."
      });
      setStep(OnboardingStep.IDLE);
      setAuthStep("onboarding");
    } catch (error) {
  ...
  const handleCreateCouple = async () => {
    ...
    const toastId = toast.loading("Criando seu espaÃ§o...", {
    ...
    try {
      ...
      toast.loading("Gerando cÃ³digo de convite...", {
        id: toastId
      });
      const {
        data: inviteCode,
      ...
      const errorMessage = isTimeout ? "A conexÃ£o expirou. Tente novamente em um local com sinal melhor." : "NÃ£o conseguimos criar seu espaÃ§o. Verifique sua conexÃ£o e tente novamente.";
      setOnboardingError(errorMessage);
      toast.error("Erro ao criar espaÃ§o", {
        id: toastId,
        description: error.message
      });
    } finally {
  ...
  const handleJoinCouple = async () => {
    ...
    const toastId = toast.loading("Verificando convite...", {
      description: "Buscando o espaÃ§o do seu parceiro..."
    });
    try {
      ...
      const isTimeout = error.name === "AbortError";
      const errorMessage = isTimeout ? "A conexÃ£o expirou (timeout de 10s). Verifique sua internet." : error.message || "NÃ£o conseguimos conectar a este espaÃ§o. Verifique o cÃ³digo e tente novamente.";
      setOnboardingError(errorMessage);
      toast.error("Erro ao entrar", {
        id: toastId,
        description: error.message
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen flex flex-col items-center justify-center bg-white dark:bg-black p-4 relative overflow-hidden", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { initial: {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center space-y-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "inline-flex items-center justify-center w-20 h-20 mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: "/CoupleDin.png", alt: "CoupleDin", className: "w-full h-full object-contain drop-shadow-xl" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-3xl font-black tracking-tight text-foreground", children: "CoupleDin" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground italic", children: "Seu patrimÃ´nio, sonhos e planos em harmonia." })
      ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center space-y-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-black tracking-tight text-foreground", children: step === OnboardingStep.ERROR ? "Oops!" : `Quase lÃ¡, ${name}!` }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground", children: step === OnboardingStep.ERROR ? "Algo nÃ£o saiu como o esperado." : "Como vocÃª quer comeÃ§ar no CoupleDin?" })
      ] }),
      step === OnboardingStep.ERROR ? /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "apple-card p-8 text-center space-y-6 border-destructive/20 bg-destructive/5 backdrop-blur-md", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-xl font-bold text-foreground", children: "Falha na conexÃ£o" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm leading-relaxed", children: onboardingError || "NÃ£o conseguimos conectar a este espaÃ§o. Verifique o cÃ³digo e tente novamente." })
        ] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "apple-card hover:border-primary/50 transition-all cursor-pointer group", onClick: handleCreateCouple, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { className: "p-6", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-lg", children: "Criar um novo espaÃ§o" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "apple-card", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { className: "p-6 pb-4", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-lg", children: "Entrar em um espaÃ§o" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(CardDescription, { children: "Insira o cÃ³digo enviado pelo seu parceiro(a)." })
          ] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { className: "text-center", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-2xl font-bold", children: "EspaÃ§o Criado!" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardDescription, { children: "Compartilhe o cÃ³digo abaixo com seu parceiro." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "space-y-6 pb-8 px-8", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-center text-muted-foreground italic", children: "Seu parceiro aparecerÃ¡ automaticamente assim que entrar com este cÃ³digo." })
          ] })
        ] })
      ] })
    ] }, "onboarding-step") }) })
