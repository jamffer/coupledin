...
import { D as DashboardLayout, T as TooltipProvider, u as useProfile, i as Dialog, r as DialogTrigger, j as DialogContent, k as DialogHeader, l as DialogTitle, m as DialogDescription, S as Select, b as SelectTrigger, c as SelectValue, d as SelectContent, e as SelectItem } from "./layout-dashboard-OebCEwYc.mjs";
...
import { z as CreditCard, c as CircleCheck, r as Calendar, w as ChevronRight, E as EllipsisVertical, L as LoaderCircle, P as Plus } from "../_libs/lucide-react.mjs";
    ...
    queryFn: async () => {
      ...
      return data.map((card) => {
        ...
        return {
          ...
          type: card.card_type === "Meu CartÃ£o" ? "individual" : "conjunto",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(DashboardLayout, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(TooltipProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { variants: containerVariants, initial: "hidden", animate: "visible", className: "space-y-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-end", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-bold tracking-tight text-foreground", children: "Meus CartÃµes" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-0", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Table, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(TableRow, { className: "bg-muted/30 hover:bg-muted/30", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { children: "DescriÃ§Ã£o" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { children: "Categoria" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { children: "Parcela" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { children: "ResponsÃ¡vel" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: "text-right pr-6 min-w-[120px]", children: "AÃ§Ãµes" }),
    ...
    ] }) : isCardsLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center items-center h-64", children: /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "h-8 w-8 animate-spin text-primary" }) }) : /* @__PURE__ */ jsxRuntimeExports.jsx(EmptyState, { icon: CreditCard, title: "VocÃª ainda nÃ£o cadastrou nenhum cartÃ£o", description: "Organize seus limites e faturas em um sÃ³ lugar.", actionLabel: "Adicionar CartÃ£o", onAction: () => {
    }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(AddCardModal, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { className: "mt-4 apple-interactive rounded-xl px-8 shadow-lg shadow-primary/20 font-bold", children: "Adicionar CartÃ£o" }) }) })
  ] }) }) });
}
export {
