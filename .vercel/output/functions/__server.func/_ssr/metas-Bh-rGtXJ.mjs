...
import { D as DashboardLayout, A as Avatar, g as AvatarImage, h as AvatarFallback } from "./layout-dashboard-irdFI0U9.mjs";
...
function MetasPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(DashboardLayout, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { variants: containerVariants, initial: "hidden", animate: "visible", className: "space-y-10 pb-10", children: [
    ...
    ] }) }, goal.id)) }) }) : /* @__PURE__ */ jsxRuntimeExports.jsx(EmptyState, { icon: Target, title: "Nenhum cofre ou meta ainda", description: "Crie metas para suas viagens, sonhos ou reserva de emergência.", actionLabel: "Criar minha primeira meta", onAction: () => toast.info("Funcionalidade de metas em breve!") })
  ] }) });
}
export {
