...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-D6zUZohS.mjs");
...
const manifest = {
  "ff0ad7c6eed40bcfc0fa108fa7a794fdd29fbdeedb9161f153630792ad349914": {
    ...
    importer: () => import("./transactions.functions-bnUD4t7Z.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-r--sMQdH.mjs").then((n) => n.r),
    import("./start-ZjiTGiqZ.mjs"),
