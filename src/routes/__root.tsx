...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "CoupleDin" },
      { name: "description", content: "CoupleDin ajuda casais a organizar finanças, cartões, metas e investimentos em um só lugar." },
      { name: "author", content: "CoupleDin" },
      { property: "og:title", content: "CoupleDin" },
      { property: "og:description", content: "Finanças do casal organizadas em um só lugar." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@CoupleDin" },
      { name: "twitter:title", content: "CoupleDin" },
      { name: "twitter:description", content: "Finanças do casal organizadas em um só lugar." },
